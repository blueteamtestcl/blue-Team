...
> **HUMAN-IN-THE-LOOP NOTICE:** The AI engine integrated into this platform is an assistive tool designed to reduce analyst burnout and accelerate initial triage. All code remediation suggestions generated by the AI **must be reviewed, validated, and approved by a qualified human engineer** before being deployed to any production environment. The AI does not replace professional judgement.
...
> **AVISO DE SUPERVISION HUMANA:** El motor de IA integrado en esta plataforma es una herramienta de asistencia disenada para reducir el burnout del analista y acelerar el triaje inicial. Todas las sugerencias de remediacion generadas por la IA **deben ser revisadas, validadas y aprobadas por un ingeniero humano calificado** antes de ser desplegadas en cualquier entorno de produccion. La IA no reemplaza el criterio profesional.
